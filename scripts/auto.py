...
class Snippet:
    ...
    def create_full_user(self, data_u):
        ...
        file_name = str(i)+'.jpg'
        EXT_FILE_PATH = 'hiker_backend/images/avs/'
    ...
    def auto_user(self):
        ...
        file_name = str(i)+'.jpg'
        EXT_FILE_PATH = 'hiker_backend/images/country/'
        lf = self.tmpf(file_name,EXT_FILE_PATH)
        ...
        # creating regions
        regions = ["Європа", "Азія", "Океанія", "Америка", "Африка", "Австаралія"]
        i = random.randint(1, 399)
        file_name = str(i)+'.jpg'
        EXT_FILE_PATH = 'hiker_backend/images/region/'
        lf = self.tmpf(file_name,EXT_FILE_PATH)
        region_id = Region.objects.create(title='Холодні зони',
        ...
        for j in range(6):
            ...
            i = random.randint(1, 399)
            file_name = str(i) + '.jpg'
            EXT_FILE_PATH = 'Documents/Myweb/images/region/'
            lf = self.tmpf(file_name, EXT_FILE_PATH)
        ...
        Faker.seed(0)
        i = random.randint(1, 399)
        tags_names= ["Пляж","Гори","Пустині","Комфорт","Холод","Жара","Дорого","Дешево","Екзотично","Острова","Небезпечно","Безпечно"]
        ...
        for ii in range(100):
            ...
            i = random.randint(1, 363)
            file_name = str(i) + '.jpg'
            EXT_FILE_PATH = 'Documents/Myweb/images/country/'
            lf = self.tmpf(file_name, EXT_FILE_PATH)
